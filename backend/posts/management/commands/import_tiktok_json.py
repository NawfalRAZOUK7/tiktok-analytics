"""
Django management command to import TikTok posts from JSON file.

Usage:
    python manage.py import_tiktok_json path/to/posts.json
    python manage.py import_tiktok_json path/to/posts.json --dry-run
    python manage.py import_tiktok_json path/to/posts.json --clear-existing
"""
...
class Command(BaseCommand):
    help = 'Import TikTok posts from a JSON file'
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--clear-existing',
            action='store_true',
            help='Delete all existing posts before importing'
        )
        parser.add_argument(
            '--skip-duplicates',
            action='store_true',
        ...
        parser.add_argument(
            '--update-duplicates',
            action='store_true',
            help='Update existing posts instead of skipping them'
        )
